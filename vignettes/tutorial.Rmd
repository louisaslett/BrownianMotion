...
Further note that the syntax of the `delete.skeleton()` function matches that of `add.segment()`. It is possible to remove segments, 


a bit about delete.skeleton with discontinuties
